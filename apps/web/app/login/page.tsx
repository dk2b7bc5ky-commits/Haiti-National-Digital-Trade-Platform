  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-sm">
        <div className="mb-6">
          <p className="text-sm font-medium uppercase tracking-widest text-sky-600">{t('login.brand')}</p>
        ...
        <div className="mt-5 rounded-xl border border-slate-200 bg-white p-4">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">{t('login.demoAccounts')}</p>
          <p className="mb-2 mt-1 text-xs text-slate-400">{t('login.passwordIs')} <code className="rounded bg-slate-100 px-1">password123</code></p>
        ...
        <p className="mt-5 text-center text-xs text-slate-400">
          <Link href="/vision" className="hover:text-sky-700 hover:underline">{t('login.visionLink')}</Link>
        </p>
      </div>
    </main>
  );
