...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  IMPORTER: [
    ...
    P.PAYMENT_CREATE, P.PAYMENT_AUTHORIZE, P.DASHBOARD_VIEW,
  ],
  BROKER: [
    P.ORG_READ, P.USER_READ, P.APIKEY_MANAGE, P.CONTAINER_READ, P.CHARGE_READ,
    P.PAYMENT_CREATE, P.PAYMENT_AUTHORIZE, P.VERIFICATION_READ, P.DASHBOARD_VIEW,
  ],
  TRUCKER: [P.ORG_READ, P.USER_READ, P.CONTAINER_READ, P.DASHBOARD_VIEW],
  TERMINAL: [P.ORG_READ, P.USER_READ, P.CONTAINER_READ, P.CHARGE_WRITE],
