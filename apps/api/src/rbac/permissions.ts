...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  REZO_OPS: [
    ...
    P.VERIFICATION_READ, P.VERIFICATION_RESOLVE, P.DOCUMENT_WRITE, P.DASHBOARD_VIEW,
  ],
  ...
  IMPORTER: [
    ...
    P.PAYMENT_CREATE, P.PAYMENT_AUTHORIZE, P.DOCUMENT_WRITE, P.DASHBOARD_VIEW,
  ],
  BROKER: [
    P.ORG_READ, P.USER_READ, P.APIKEY_MANAGE, P.CONTAINER_READ, P.CHARGE_READ,
    P.PAYMENT_CREATE, P.PAYMENT_AUTHORIZE, P.VERIFICATION_READ, P.DOCUMENT_WRITE, P.DASHBOARD_VIEW,
  ],
  TRUCKER: [P.ORG_READ, P.USER_READ, P.CONTAINER_READ, P.DASHBOARD_VIEW],
  TERMINAL: [P.ORG_READ, P.USER_READ, P.CONTAINER_READ, P.CHARGE_WRITE, P.DOCUMENT_WRITE],
  CUSTOMS: [P.ORG_READ, P.TENANT_READ_ALL, P.CONTAINER_READ, P.CHARGE_READ],
