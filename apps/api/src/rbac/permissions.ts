...
export const Permission = {
  ...
  /** Quick-add a single container (importers add their own; admins on behalf). */
  ...
  /** See the email agent's status and what it read. */
  MAIL_INTAKE_READ: 'mail_intake:read',
  /** Connect/configure the mailbox and confirm or reject what the agent read. */
  MAIL_INTAKE_MANAGE: 'mail_intake:manage',
} as const;
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  REZO_ADMIN: [
    ...
    P.MANIFEST_SUBMIT, P.CONTAINER_READ, P.CONTAINER_CREATE, P.CHARGE_READ, P.CHARGE_WRITE,
    ...
    P.MAIL_INTAKE_READ, P.MAIL_INTAKE_MANAGE,
  ],
  REZO_OPS: [
  ...
  IMPORTER: [
    P.ORG_READ, P.USER_READ, P.CONTAINER_READ, P.CONTAINER_CREATE, P.CHARGE_READ,
    P.PAYMENT_CREATE, P.PAYMENT_AUTHORIZE, P.DOCUMENT_WRITE,
    P.INSPECTION_REQUEST, P.TRANSPORT_MANAGE, P.DASHBOARD_VIEW,
    P.MAIL_INTAKE_READ, P.MAIL_INTAKE_MANAGE,
  ],
  BROKER: [
    P.ORG_READ, P.USER_READ, P.APIKEY_MANAGE, P.CONTAINER_READ, P.CONTAINER_CREATE, P.CHARGE_READ,
